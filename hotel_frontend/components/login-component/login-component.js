function loginTemplate(){
    return '<div class="row d-flex justify-content-center align-items-center p-5 h-100" id="login-component">\n' +
        ...
        '\n' +
        '                            <button class="btn btn-outline-dark btn-lg px-5 " type="button" onclick="logar(login, senha)">Login</button>\n' +
        '                            </form>\n' +
        ...
        '\n' +
        '                        <div>\n' +
        '                            <p class="mb-0">Não tem uma conta? <button class="btn btn-link mt-2" onclick="usuarioRegistroComponent()">Registre-se</a>\n' +
        '                            </p>\n' +
        '                        </div>\n' +
        '\n' +
        '                    </div>\n' +
