function quartoEditarTemplate(idQuarto){
    return '<div class="row d-flex justify-content-center align-items-center p-5 h-100 w-100" id="quarto-editar-component">\n' +
        ...
        '                    <div>\n' +
        '                        <h2 class="fw-bold mb-2 text-uppercase">Editar Quarto</h2>\n' +
        ...
        '                                       class="form-control form-control-lg"/>\n' +
        '                            </div>\n' +
        '                            <button class="btn btn-outline-primary btn-lg px-5" type="button" onclick="editarQuarto(login, senha, ' + idQuarto  + ')">\n' +
        '                                Enviar\n' +
        '                            </button>\n' +
        '                        </form>\n' +
        '                    </div>\n' +
