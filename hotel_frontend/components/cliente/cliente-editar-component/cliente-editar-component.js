function clienteEditarTemplate(id){
    return '<div class="row d-flex justify-content-center align-items-center p-5 h-100 w-100" id="cliente-editar-component">\n' +
        ...
        '                    <div>\n' +
        '                        <h2 class="fw-bold mb-2 text-uppercase">Editar Cliente ' + id + '</h2>\n' +
        '                        <p class="text-dark-50 mb-5">Por favor informe os novos dados do cliente!</p>\n' +
        ...
        '                            <div class="row">\n' +
        '                               <div class="col form-outline form-white mb-4">\n' +
        '                                   <input type="text" class="form-control cpf" placeholder="CPF" onkeyup="validaClienteFormFields()">\n' +
        '                               </div>\n' +
        '                               <div class="col form-outline form-white mb-4">\n' +
        ...
        '                                Voltar\n' +
        '                            </button>\n' +
        '                            <button class="btn btn-outline-primary btn-lg px-5 botao-enviar" type="button" onclick="editarCliente(' + id + ')" disabled>\n' +
        '                                Enviar\n' +
        '                            </button>\n' +
        '                        </form>\n' +
        '                    </div>\n' +
...
function clienteEditarComponent(){
    let id = $(".cliente-input-radio:checked").val();
        removeTemplateAnterior();
        closeSidebar();
        $(CONTAINER).append(clienteEditarTemplate(id));
